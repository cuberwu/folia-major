...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "search-aggregate": { "title": "聚合搜索", "description": "搜索网易云、酷狗和 QQ 音乐" },
      "search-kugou": { "title": "搜索酷狗", "description": "搜索酷狗歌曲" },
      "search-qq": { "title": "搜索 QQ 音乐", "description": "搜索 QQ 音乐歌曲" },
  ...
  "home": {
    ...
    "guestPrompt": "可通过内置接口搜索音乐，也可登录在线音乐平台，访问您的歌单、收藏专辑和电台。\n登录状态仅保存在当前设备，不会存储到服务器。",
    "guestPromptProvider": "登录 {{provider}}，访问您的在线音乐库。",
    "multiPlatformLoginTitle": "先搜几首喜欢的歌试试看",
    "multiPlatformLoginPrompt": "可通过内置接口搜索音乐，也可登录在线音乐平台，访问您的歌单、收藏专辑和电台。\n登录状态仅保存在当前设备，不会存储到服务器。",
